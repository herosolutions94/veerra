...
const CreateVeerraFiedReview = ({ formPopup1, setFormPopup1 }) => {
  return (
    <>
      {formPopup1 === true ? (
        <div
              ...
              <div class="contain">
                <div className="col1">
                  <div class="inner_form profile_forms">
                    <div
                      className="crosBtn"
                      onClick={() => setFormPopup1(false)}></div>
                    <form>
                      <h4>Create an Veerra-fied Review</h4>
                        ...
                        <div className="inner long_form_pro">
                          <div className="flex">
                            <div className="txtGrp">
                              <p>
                                Congratulations on a successful transaction! You
                                can now provide an honest review of your
                                experience with this agent. Any personal or
                                offensive details may cause your review to be
                                removed.
                              </p>
                            </div>
                          </div>
...
export default CreateVeerraFiedReview;
