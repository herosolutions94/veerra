...
const BecomeTeamLeader = ({ formPopup, setFormPopup }) => {
                ...
                <div className="col1">
                  <div class="inner_form">
                    ...
                    <form>
                      ...
                      <div className="flex1">
                        <p>
                          You must currently be a Free Agent to start a new team
                          and become a Team Leader. Please fill out all sections
                          below. Changes cannot be reversed.
                        </p>
                      </div>
                      <div className="flex">
...
export default BecomeTeamLeader;
